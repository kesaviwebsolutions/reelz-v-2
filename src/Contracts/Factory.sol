...
contract R33lz721NFTs is ERC721Enumerable, Ownable {
    using Strings for uint256;
...
contract R33lz1155NFTs is ERC1155, Ownable {
    string public name;
...
contract NFTCollectionFactory {
    ...
    function createNFT721(
        ...
        R33lz721NFTs newNFTCollection = new R33lz721NFTs(
            name,
            symbol,
            baseURI,
            supply
        );
        newNFTCollection.transferOwnership(tx.origin);
    ...
    function createNFT1155(
        ...
        R33lz1155NFTs newNFTCollection = new R33lz1155NFTs(
            _name,
            _symbol,
            _id,
            _totalSupply,
